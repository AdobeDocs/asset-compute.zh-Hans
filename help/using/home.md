...
[!DNL Asset Compute Service]是Adobe Experience Cloud的一项用于处理数字资源的可扩展服务。 它可以将图像、视频、文档和其他文件格式转换为不同的呈现形式，包括缩略图、提取的文本和元数据、存档等。 开发人员能够插入自定义应用程序（也称为自定义工作程序）以解决自定义用例，这些用例是使用[Adobe Developer App Builder](https://developer.adobe.com/app-builder/docs/intro_and_overview/#)构建的，并在无服务器的Adobe [[!DNL I/O Runtime]](https://developer.adobe.com/runtime/)中运行。
...
查看有关[as a [!DNL Adobe Experience Manager]  [!DNL Cloud Service]中提供的](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/assets/asset-microservices-overview)资源微服务功能以及如何在[!DNL Experience Manager]中使用微服务的概述。
