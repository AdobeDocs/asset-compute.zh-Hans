...
自定义应用程序是Headless [Adobe Developer App Builder](https://github.com/AdobeDocs/app-builder)应用程序。 通过[Asset Compute SDK](https://github.com/adobe/asset-compute-sdk)和Adobe Developer App Builder开发人员工具，可以轻松扩展包含自定义应用程序的[!DNL Asset Compute Service]。 这些工具让开发人员专注于业务逻辑。 创建自定义应用程序与创建无服务器的Adobe [!DNL I/O Runtime]操作一样简单。 它是单个Node.js JavaScript函数。 [基本自定义应用程序示例](https://github.com/adobe/asset-compute-example-workers/blob/master/projects/worker-basic/worker-basic.js)对此进行了说明。
...
* [!DNL Experience Cloud]组织。 有关详细信息，请转到[启动历程](https://developer.adobe.com/app-builder/docs/get_started/app_builder_get_started/first-app#acquire-access-and-credentials)。
